...
const ROOM_PLANS = Object.freeze({
  gardenTwin: {
    id: 'gardenTwin',
    labelZh: '花園雙床客房',
    labelEn: 'Garden Twin Room',
    formValue: '花園雙床客房 / Garden Twin Room',
    priceTwd: 32800,
  ...
  gardenSingle25: {
    ...
    formValue: '花園單人客房 25㎡ / Garden Single Room 25 sqm',
    priceTwd: 39800,
    depositTwd: DEPOSIT_AMOUNT_TWD,
  },
  gardenViewSingle35: {
    id: 'gardenViewSingle35',
    labelZh: '花園景觀單人房 35㎡',
    labelEn: 'Garden View Single Room 35 sqm',
    formValue: '花園景觀單人房 35㎡ / Garden View Single Room 35 sqm',
    priceTwd: 42800,
    depositTwd: DEPOSIT_AMOUNT_TWD,
  },
  gardenBungalowFour: {
    ...
    formValue: '庭園雙臥木屋｜四位同行 / Garden Bungalow for Four',
    priceTwd: 34800,
    depositTwd: DEPOSIT_AMOUNT_TWD,
    occupancy: 4,
  },
  gardenBungalowThree: {
    ...
    formValue: '庭園雙臥木屋｜三位同行 / Garden Bungalow for Three',
    priceTwd: 40800,
    depositTwd: DEPOSIT_AMOUNT_TWD,
    occupancy: 3,
  },
  privateBungalowTwo: {
    id: 'privateBungalowTwo',
    labelZh: '獨棟庭園木屋｜兩人入住',
    labelEn: 'Private Bungalow for Two',
    formValue: '獨棟庭園木屋｜兩人入住 / Private Bungalow for Two',
    priceTwd: 44800,
    depositTwd: DEPOSIT_AMOUNT_TWD,
    occupancy: 2,
  },
  privateBungalowSingle: {
    id: 'privateBungalowSingle',
    labelZh: '獨棟庭園木屋｜一人獨享',
    labelEn: 'Private Bungalow Single Stay',
    formValue: '獨棟庭園木屋｜一人獨享 / Private Bungalow Single Stay',
    priceTwd: 53800,
    depositTwd: DEPOSIT_AMOUNT_TWD,
    occupancy: 1,
  },
